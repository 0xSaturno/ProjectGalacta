...
The goal is to go beyond the game's current modding ceiling. The modding scene has been stuck to simple cosmetic mesh, texture, and material swaps for too long – this project aims to push that and Skin Swapper it's the proof of it. Right now, that's three independent pieces:
